<template>
  <div class="maindiv">
   ...
   <!-- <div v-for="items in allBooks" :key="items._id" class="page">{{allBooks.bookId}}
        </div>
        <div class="change">
           <b-pagination
        :items="allBooks"
...
// import Pagenination from './Pagenination.vue';
import Page from "./Pagenination.vue";
export default {
  components: { Page },
  name: "DisplayBooks",


  props: ["allBooks", "total","items"],
...
//  onChangePage:function(books) { 
//       // update page of items  
//       this.allBooks = books;
//       console.log("the page number is ",books);
//     },
